...
CANNON.Demo = function(options){
    ...
    */
    ...
    var MARGIN = 0;
    var SCREEN_WIDTH = parseFloat(document.getElementById(settings.container).style.width);//window.innerWidth;
    var SCREEN_HEIGHT = parseFloat(document.getElementById(settings.container).style.height);//window.innerHeight - 2 * MARGIN;
